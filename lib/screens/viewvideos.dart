...
class ViewVideos extends StatefulWidget {
  ...
  ViewVideos(this.vidPath);  @override
  _ViewVideosState createState() => _ViewVideosState();
}class _ViewVideosState extends State<ViewVideos> {
  var filePath;
  final String vidShare = "Image.file(File(widget.vidPath),)";  final LinearGradient backgroundGradient = new LinearGradient(
    colors: [
      Color(0x00000000),
      Color(0x00333333),
    ],
  ...
  Widget build(BuildContext context) {
    ...
    var _fabMiniMenuItemList = [
      new FabMiniMenuItem.withText(
          ...
          () async {
        _onLoading(true, "");        Uri myUri = Uri.parse(widget.vidPath);
